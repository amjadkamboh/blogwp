 ...
 * AMS Child Theme.
 *
 * This file adds the required helper functions used in the AMS Child Theme Theme.
 *
 ...
 */
function ams_color_contrast( $color ) {
 ...
 */
function ams_color_brightness( $color, $change ) {
