 ...
 * AMS Child Theme.
 *
 * This file adds the required WooCommerce setup functions to the AMS Child Theme Theme.
 *
...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'ams_woocommerce_breakpoint' );
/**
 ...
 */
function ams_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'ams_default_products_per_page' );
/**
 ...
 */
function ams_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'ams_woocommerce_pagination' );
/**
 ...
 */
function ams_woocommerce_pagination( $args ) {
...
add_action( 'after_switch_theme', 'ams_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function ams_woocommerce_image_dimensions_after_theme_setup() {
	...
	ams_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'ams_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function ams_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function ams_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'ams_gallery_image_thumbnail' );
/**
 ...
 */
function ams_gallery_image_thumbnail( $size ) {
