 ...
 * AMS Child Theme.
 *
 * This file adds the WooCommerce styles and the Customizer additions for WooCommerce to the AMS Child Theme Theme.
 *
...
add_filter( 'woocommerce_enqueue_styles', 'ams_woocommerce_styles' );
/**
 ...
 */
function ams_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'ams_woocommerce_css' );
/**
...
function ams_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'ams_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'ams_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		ams_color_contrast( $color_accent )
	) : '';
