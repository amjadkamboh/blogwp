 ...
 * AMS Child Theme.
 *
 * This file adds the required CSS to the front end to the AMS Child Theme Theme.
 *
...
add_action( 'wp_enqueue_scripts', 'ams_css' );
/**
...
function ams_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'ams_logo_width', 350 );
