...
add_action( 'wp_enqueue_scripts', 'ams_custom_gutenberg_css' );
/**
 * Outputs front-end inline styles based on colors declared in config/appearance.php.
 *
 * @since 2.9.0
 */
function ams_custom_gutenberg_css() {
...
CSS;
	...
	$css .= ams_inline_font_sizes();
	$css .= ams_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'ams_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function ams_custom_gutenberg_admin_css() {
...
CSS;
	...
	$css .= ams_editor_inline_color_palette();
 ...
 */
function ams_inline_font_sizes() {
 ...
 */
function ams_inline_color_palette() {
 ...
 * @return string The editor colors CSS if `editor-color-palette` theme support was declared.
 */
function ams_editor_inline_color_palette() {
